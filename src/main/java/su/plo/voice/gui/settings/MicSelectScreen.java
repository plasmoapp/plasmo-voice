...
public class MicSelectScreen extends BackgroundScreen {
    ...
    public MicSelectScreen(Screen parent) {
        super(new TranslationTextComponent("gui.plasmo_voice.select_mic"), 248, 180, TEXTURE, true);
        this.parent = parent;
    ...
    protected void init() {
        ...
        this.deviceListWidget = new DeviceListWidget(this.client, 240, 132, this.guiTop + 12,
                new TranslationTextComponent("gui.plasmo_voice.select_mic"));
