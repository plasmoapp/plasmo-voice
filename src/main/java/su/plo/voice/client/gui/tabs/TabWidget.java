...
public class TabWidget extends ContainerObjectSelectionList<TabWidget.Entry> {
    ...
    private TabWidget.Entry hoveredEntry;
...
//        super(minecraftClient, width, height, top, bottom, itemHeight);
    ...
    protected int getMaxPosition() {
        ...
        for (TabWidget.Entry entry : children()) {
    ...
    @Override
    protected void centerScrollOn(TabWidget.Entry entry) {
        int height = 0;
    ...
    @Override
    protected void ensureVisible(TabWidget.Entry entry) {
    ...
    private TabWidget.Entry getDynamicEntryAtPosition(double x, double y) {
    ...
    protected void renderList(PoseStack matrices, int x, int y, int mouseX, int mouseY, float delta) {
        ...
        for(int j = 0; j < i; ++j) {
            ...
            if (l >= this.y0 && k <= this.y1) {
                TabWidget.Entry entry = this.getEntry(j);
...
//                System.out.println(r);
    ...
    public abstract static class Entry extends ContainerObjectSelectionList.Entry<TabWidget.Entry> {
        @Getter
        private int height;
    ...
    public class CategoryEntry extends TabWidget.Entry {
        ...
        public List<? extends NarratableEntry> narratables() {
            return ImmutableList.of(new NarratableEntry() {
                ...
                public void updateNarration(NarrationElementOutput builder) {
                    builder.add(NarratedElementType.TITLE, TabWidget.CategoryEntry.this.text);
                }
            });
        }
    }
