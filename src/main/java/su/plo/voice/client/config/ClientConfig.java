...
public class ClientConfig extends AbstractConfig {
    static {
        ...
        builder.registerTypeAdapter(ClientConfig.MicrophoneIconPositionConfigEntry.class, new ClientConfig.MicrophoneIconPositionConfigEntry());
        ...
        builder.registerTypeAdapter(ClientConfig.KeyBindingConfigEntry.class, new ClientConfig.KeyBindingConfigEntry());
        gson = builder.create();
    }
