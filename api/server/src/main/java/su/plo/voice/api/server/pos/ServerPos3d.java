...
public class ServerPos3d {
    ...
    public ServerPos3d(@NotNull VoiceWorld world, double x, double y, double z) {
        this(world, x, y, z, 0, 0);
    }

    public ServerPos3d(@NotNull VoiceWorld world, double x, double y, double z, float yaw, float pitch) {
        this.world = world;
