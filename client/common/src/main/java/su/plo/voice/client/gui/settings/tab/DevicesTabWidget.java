...
public final class DevicesTabWidget extends TabWidget {
    ...
    public DevicesTabWidget(MinecraftClientLib minecraft,
    ...
    private OptionEntry<DropDownWidget> createMicrophoneEntry() {
        ...
        if (config.getVoice().getUseJavaxInput().value()) {
            ...
            if (!deviceFactory.isPresent()) throw new IllegalStateException("Javax Input device factory not initialized");
        } else {
